    ...
    <div class="mobil" style="margin: 100px 100px;">
        ...
        <form action="../config/insert.php" method="POST" style="padding-top: 30px;">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="nama_merk" name="nama_merk"aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <div>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="status_bayar" id="inlineRadio1" value="lunas">
                    <label class="form-check-label" for="inlineRadio1">Lunas</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="status_bayar" id="inlineRadio2" value="belum lunas">
                    <label class="form-check-label" for="inlineRadio2">Belum Lunas</label>
                </div>
            </div>

            <a href="ListCar-Ida.php"><button type="submit" class="btn btn-primary" name="simpan" value="Simpan" style="margin-top: 30px; width: 110px;">Selesai</button></a>
